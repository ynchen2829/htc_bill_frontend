    ...
    <>
      ...
      <div className='block items-center flex-wrap bg-lime-50 p-3 '>
            <div className="flex w-1/2 m-auto border border-purple-200 rounded">
                ...
                />
                <button onClick={handleSearch}className="px-4 text-white bg-blue-300 border-l rounded ">
                    Search
                </button>
            </div>
        </div>
      ...
      <footer className="md:flex justify-center p-4">
        <nav aria-label="Page navigation example">
          <ul className="inline-flex -space-x-px">
            <li>
              <a href={id==1 ? "1" : String(id-1)} className="px-3 py-2 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Previous</a>
            </li>
            <li>
              <a aria-current="page" className="px-3 py-2 text-blue-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">{id}</a>
            </li>
            <li>
              <a href={Number(id)==limit ? String(limit) : String(id+1)} className="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next</a>
            </li>
          </ul>
        </nav>
      </footer>
